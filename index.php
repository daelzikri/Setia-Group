...
<head>
    ...
    <title><?= htmlspecialchars($profil['nama_brand']) ?> - Event Organizer Profesional</title>
...
<body class="bg-white">
    ...
    <section class="relative bg-cover bg-center text-white" style="background-image: url('assets/header.jpg');">
        ...
        <div class="container mx-auto px-4 py-48 md:py-64 relative z-10">
            <div class="max-w-4xl mx-auto text-center fade-in">
                <span class="inline-block tracking-[0.3em] uppercase text-sm mb-4 text-blue-300 font-semibold">Event Organizer Specialist</span>
                <h1 class="text-5xl md:text-7xl font-bold mb-8 hero-font leading-tight"><?= htmlspecialchars($profil['nama_brand']) ?></h1>
                <p class="text-xl md:text-2xl mb-12 text-gray-200 font-light"><?= htmlspecialchars($profil['tagline']) ?></p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="img-stack fade-in">
                    <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&q=80" class="img-stack-main" alt="Event setup">
                ...
                <div class="fade-in">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-8 hero-font">Welcome to <?= htmlspecialchars($profil['nama_brand']) ?></h2>
                    <div class="text-lg text-gray-600 mb-6 leading-relaxed">
                        <?= $profil['deskripsi_intro'] ?>
                    </div>
                    <a href="about.php" class="btn-elegant bg-[#051094] text-white px-12 py-4 font-bold inline-block shadow-lg hover:bg-black transition-colors">Read More</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-end mb-14 gap-6">
                <div class="max-w-2xl fade-in">
                    <div class="accent-line"></div>
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 hero-font">Event Terbaru Kami</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <div class="group relative h-[480px] rounded-[2.5rem] overflow-hidden shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div class="text-center mt-16">
                <a href="event.php" class="btn-elegant bg-[#051094] text-white px-12 py-4 font-bold hover:bg-black inline-block transition shadow-xl tracking-widest">
                    Lihat Semua Event
                </a>
            </div>
        </div>
    ...
    <section class="py-24 bg-gray-50 border-y border-gray-100">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 divide-x-0 lg:divide-x divide-gray-200">
                <div class="text-center lg:px-8">
                    <p class="text-[10px] font-bold text-[#051094] uppercase tracking-[0.3em] mb-4">Established</p>
                    <h4 class="text-5xl font-bold text-gray-900 hero-font">2005</h4>
                </div>
                <div class="text-center lg:px-8">
                    <p class="text-[10px] font-bold text-[#051094] uppercase tracking-[0.3em] mb-4">Projects Done</p>
                    <h4 class="text-5xl font-bold text-gray-900 hero-font">500+</h4>
                </div>
                <div class="text-center lg:px-8">
                    <p class="text-[10px] font-bold text-[#051094] uppercase tracking-[0.3em] mb-4">Global Partners</p>
                    <h4 class="text-5xl font-bold text-gray-900 hero-font">120+</h4>
                </div>
                <div class="text-center lg:px-8">
                    <p class="text-[10px] font-bold text-[#051094] uppercase tracking-[0.3em] mb-4">Awards Won</p>
                    <h4 class="text-5xl font-bold text-gray-900 hero-font">15</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white border-y border-gray-50 overflow-hidden">
        <div class="container mx-auto px-4 mb-12">
            <div class="text-center">
                <span class="text-[#051094] font-bold text-[10px] uppercase tracking-[0.5em] mb-4 block">Trusted by Prestigious Organizations</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 hero-font">Klien & Mitra Strategis</h2>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 mt-12">
            <p class="text-[10px] text-gray-400 font-medium uppercase tracking-[0.3em] text-center italic">
                Serta berbagai instansi pemerintahan, BUMN, dan tokoh publik nasional lainnya.
            </p>
        </div>
    </section>

    <section class="py-32 bg-white" id="testimoni">
        <div class="container mx-auto px-4">
            <div class="max-w-5xl mx-auto relative">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 text-[150px] text-gray-50 hero-font select-none z-0">“</div>
                <div class="relative z-10">
                    <div class="flex flex-col items-center text-center">
                        <?php foreach($testimonials as $testi): ?>
                        <div class="mb-24 last:mb-0">
                            <p class="text-2xl md:text-3xl text-gray-700 hero-font italic leading-relaxed mb-10 max-w-4xl mx-auto">
                                "<?= htmlspecialchars($testi['isi_testimoni']) ?>"
                            </p>
                            <div class="inline-flex items-center gap-4">
                                <div class="h-[1px] w-8 bg-[#051094]"></div>
                                <span class="text-sm font-bold text-gray-900 tracking-widest uppercase"><?= htmlspecialchars($testi['nama_klien']) ?></span>
                                <span class="text-xs text-gray-400 font-light">— <?= htmlspecialchars($testi['perusahaan']) ?></span>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="relative min-h-[550px] flex items-center rounded-[4rem] overflow-hidden bg-[#051094]">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-[#051094] via-[#051094]/95 to-transparent z-10"></div>
                
                <div class="relative z-20 w-full px-12 md:px-24 grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <span class="text-blue-300 font-bold text-[10px] uppercase tracking-[0.5em] mb-6 block">Connect with us</span>
                        <h2 class="text-4xl md:text-6xl font-bold text-white hero-font mb-8 leading-tight">Menciptakan <br><span class="italic font-light text-blue-200">Legacy</span> Lewat Event.</h2>
                        <p class="text-blue-100/70 text-lg font-light leading-relaxed mb-12 max-w-md">Kami percaya setiap acara adalah mahakarya. Mari diskusikan bagaimana kami menghidupkan visi Anda menjadi realitas yang megah.</p>
                        
                        <div class="flex flex-col sm:flex-row gap-6">
                            <a href="kontak.php" class="bg-white text-[#051094] px-10 py-5 rounded-full text-[10px] font-bold uppercase tracking-widest hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all text-center">Mulai Konsultasi</a>
                            <a href="https://wa.me/<?= $no_wa ?>" class="border border-white/30 text-white px-10 py-5 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-white/10 transition-all text-center flex items-center justify-center gap-2">
                    ...
                    <div class="hidden lg:block">
                        <div class="relative">
                            <div class="w-64 h-80 rounded-[3rem] border border-white/10 absolute -top-8 -right-8 animate-pulse"></div>
                            <img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80" 
                                 class="w-72 h-96 object-cover rounded-[3rem] shadow-2xl rotate-3 hover:rotate-0 transition-all duration-700">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-12 gap-20 items-center">
                <div class="lg:col-span-5">
                    <div class="h-[1px] w-12 bg-[#051094] mb-10"></div>
                    <h2 class="text-4xl font-bold text-gray-900 mb-6 hero-font tracking-tight leading-tight">Kunjungi Studio <br><span class="text-gray-400 italic font-light">Kreatif Kami</span></h2>
                    <p class="text-gray-500 font-light leading-relaxed mb-12">Pintu kami selalu terbuka untuk diskusi inspiratif. Temukan kami di pusat bisnis Jakarta untuk konsultasi privat mengenai rencana acara Anda.</p>
                    ...
                    <div class="space-y-6">
                        <div onclick="updateMap('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.97318578627!2d116.109244474403!3d-8.598572591446587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdbf10ae56033b%3A0x6100e8701860960e!2sSETIA%20GROUP%20INDONESIA!5e0!3m2!1sid!2sid!4v1768129852325!5m2!1sid!2sid')" 
                             class="flex items-start gap-6 p-4 rounded-2xl hover:bg-blue-50 cursor-pointer transition-all duration-300 group-addr">
                            <div class="w-12 h-12 rounded-2xl bg-gray-50 group-addr-hover:bg-white flex items-center justify-center text-[#051094] flex-shrink-0 shadow-sm transition-colors">
                                <i class="fa-solid fa-location-dot"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 text-xs uppercase tracking-widest mb-2 group-hover:text-[#051094] transition-colors">Head Office (Click to View)</h4>
                                <p class="text-gray-500 text-sm font-light"><?= htmlspecialchars($profil['alamat']) ?></p>
                            </div>
                        </div>
                        ...
                        <div onclick="updateMap('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.503543679605!2d106.81430227437585!3d-6.197098693790585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f69fbffffedd%3A0x98ca409f3f88b2fd!2sThamrin%20Residences!5e0!3m2!1sid!2sid!4v1768130027883!5m2!1sid!2sid')" 
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-xs uppercase tracking-widest mb-2 group-hover:text-[#051094] transition-colors">Branch Office (Click to View)</h4>
                                <p class="text-gray-500 text-sm font-light"><?= htmlspecialchars($profil['alamat_cabang']) ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <div class="flex items-start gap-6 p-4">
                            <div class="w-12 h-12 rounded-2xl bg-gray-50 flex items-center justify-center text-[#051094] flex-shrink-0 shadow-sm"><i class="fa-solid fa-envelope"></i></div>
                            <div>
                                <h4 class="font-bold text-gray-900 text-xs uppercase tracking-widest mb-2">Email Inquiry</h4>
                                <p class="text-gray-500 text-sm font-light italic"><?= htmlspecialchars($profil['email']) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                
                <div class="lg:col-span-7 h-[550px] rounded-[3.5rem] overflow-hidden shadow-2xl border border-gray-100 group">
                    <iframe 
                        id="mapFrame"
